...
import 'package:weather_app/features/weather/data/repo/repo_imp.dart';
...
void getItSetup(){
  ...
  getIt.registerSingleton<WeatherService>(ApiService(dio: getIt<Dio>()));
  getIt.registerSingleton<Repo>(
    RepoImp(weatherService: getIt<WeatherService>(), locationService: LocationService()),
  );
}